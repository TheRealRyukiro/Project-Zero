class Inventory{
    ...
    getItemList(){return this.Items.join("\n");}
    // Setters
...
class Player {
    ...
    // Setters
    setMoney() {return ++this.Money;}    
    setHealth(Health){return ++this.Health;}
    setMaxHealth(Health){return ++this.MaxHealth;}
    setName(Name){return ++this.Name;}
    displayHealth() {return this.Health.toString() + " / " + this.maxHealth.toString()}
    displayMoney() {return "$" + this.Money.toString()}
